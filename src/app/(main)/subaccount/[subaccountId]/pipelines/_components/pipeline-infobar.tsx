...
import { CustomCommandEmpty, CustomCommandItem } from '@/components/forms/items-pipeline'
      ...
      <div className='flex items-end gap-2'>
        ...
        >
          ...
          <PopoverContent className="w-[200px] p-0">
            <Command>
              {pipelines.length === 0 ? (
                <CustomCommandEmpty>No pipelines found.</CustomCommandEmpty>
              ) : (
                <CommandGroup>
                  {pipelines.map((pipeline) => (
                    ...
                    >
                      <CustomCommandItem
                        key={pipeline.id}
                        value={pipeline.id}
                        onSelect={(currentValue: string | SyntheticEvent) => {
